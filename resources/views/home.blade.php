...
<h2 style="text-align:center; color:white;font-weight:bold;">WELCOME</h2>
   ...
   <br><br> 
   <div><button type="button" class="btn btn-primary" style="background-color:black; border-radius:100px;font-weight:bold;color:white;text-color:white;" ><a href="{{route('registerofficer')}}">Regester Officers</a></button></div>
   <div><br>
